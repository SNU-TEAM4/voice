...
| --- | --- | --- | --- |
| Logistic Regression | {"C": 0.1} | 14.05% | 8.91% |
| RBF-SVM | {"C": 10.0, "gamma": "scale"} | 13.6% | 6.76% |

## Test 결과

| 모델 | 평가 단위 | 표본 수 | EER | ROC-AUC | Macro-F1 | Balanced Accuracy | REAL 오탐률 | FAKE 놓침률 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Logistic Regression | segment | 1374 | 14.64% | 92.82% | 74.02% | 85.17% | 17.42% | 12.24% |
| Logistic Regression | track | 487 | 9.51% | 97.37% | 83.11% | 92.07% | 9.09% | 6.77% |
| RBF-SVM | segment | 1374 | 17.49% | 92.76% | 73.27% | 83.4% | 21.21% | 12.0% |
| RBF-SVM | track | 487 | 7.02% | 97.21% | 86.63% | 91.15% | 13.64% | 4.06% |

- Track EER이 가장 낮은 기계학습 모델: **RBF-SVM**
- 해당 Track EER: **7.02%**
- 해당 Track ROC-AUC: **97.21%**
